        ...
        <footer className="container mx-auto py-10 px-4">
            <div className="flex flex-col md:flex-row justify-between gap-8 pb-8">
                <div className="space-y-4">
                    <img src={footerLogo} alt="Dev Stack Logo" className="h-7 w-auto" />
            ...
            <div className="border-t border-gray-100 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-400 text-center sm:text-left">
